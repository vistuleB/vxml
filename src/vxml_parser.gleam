...
fn depth_first_node_to_node_desugar_many(
  ...
  let mapper = depth_first_node_to_node_desugar_one(_, ancestors, transform)
    ...
    V(blame, tag, attrs, children) -> {
        ...
        )
      {
        Ok(transformed_children) ->
          transform(V(blame, tag, attrs, transformed_children), ancestors)
        Error(err) -> Error(err)
      }
    }
  }
...
//*************************************************************************
//* desugaring efforts #4: an exampe NodeToNodeTransform (see efforts #1) *
//*************************************************************************
...
//**************************************************************************
//* desugaring efforts #5: an exampe NodeToNodesTransform (see efforts #2) *
//**************************************************************************
